...
import { generateVisualTimeline } from './ai-orchestrator.js';
 ...
 */
export async function renderNodeBasedVideo(options) {
    console.log('[Node Renderer] Starting node-based rendering...');
    const { audioPath, outputPath, duration, width, height, fps, useAI = false } = options;
 ...
 */
function encodeFramesToVideo(framesDir, audioPath, outputPath, fps) {
...
//# sourceMappingURL=node-based-renderer.js.map
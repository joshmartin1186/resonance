 ...
 */
export async function renderShaderVideo(config: ShaderRenderConfig, outputPath: string): Promise<void> {
 ...
 */
function encodeFramesToVideo(framesDir: string, outputPath: string, fps: number): Promise<void> {
 ...
 */
function createShaderProgram(gl: any, fragmentShaderSource: string): any {
 ...
 */
function setupGeometry(gl: any, program: any): void {
